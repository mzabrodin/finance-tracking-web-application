...
const TransactionsPage = () => {
    ...
    // I'm afraid, but I can't use the showNotification function here, because it will cause an infinite loop
    ...
    // Calculate total income and never expenses
    const totalIncome = transactions
        .filter(t => t.type === 'income')
        .reduce((sum, t) => sum + t.amount, 0);

    // Calculate total expenses and account balance
